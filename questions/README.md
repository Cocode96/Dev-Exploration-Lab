...
GitHub Discussions에서 각자의 생각을 나누고, 코드 실험과 공식 문서로 확인한 결론을 주제별로 정리하는 아카이브입니다.
...
각 문서에는 원래 Discussion, 처음 제시된 가설, 검증 방법, 확인된 결론, 참고 자료를 기록합니다. 첫 검증 문서가 생길 때 필요한 주제 폴더를 추가합니다.
