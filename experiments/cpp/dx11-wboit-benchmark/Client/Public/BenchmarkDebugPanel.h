...
{
  public:
    void render(Engine::ApplicationContext& context, const filesystem::path& output_directory);
    bool camera_input_enabled() const noexcept { return m_camera_input_enabled; }
    void request_benchmark_settings() { m_open_benchmark_settings = true; }
  ...
  private:
    ...
    void render_benchmark_settings(Engine::ApplicationContext& context);
    ...
    bool m_open_benchmark_settings{};
};
} // namespace Client
